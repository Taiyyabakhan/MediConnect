...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-900 md:mx-10'>
        ...
        <button onClick={()=>{navigate('/doctors');scrollTo(0,0)}} className='bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 hover:bg-secondaryColor hover:text-gray-300 hover:scale-105 transition-all duration-300'>More</button>
    </div>
  )
}
