...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Store token in localStorage to persist login state
      localStorage.setItem('token', 'true')
      
      // Dispatch custom event to notify NavBar component
      window.dispatchEvent(new CustomEvent('tokenChanged', { detail: { token: 'true' } }))
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          <img 
            ...
            className="mx-auto h-16 w-auto cursor-pointer mb-6"
            onClick={() => navigate('/')}
          />
